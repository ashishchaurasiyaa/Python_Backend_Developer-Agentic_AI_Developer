...
- [ ] ⚪ **Classical ML/DL Foundations** — perceptron→MLP→backprop→CNN→RNN/LSTM→bridge to Transformer→transfer learning→GANs/diffusion. Interview-depth only, not build-required → [Classical_ML_DL_Foundations/README.md](Agentic_AI/Level1_LLM_Foundations/Classical_ML_DL_Foundations/README.md)
  - [ ] 🟡 **Classical ML algorithms** *(NEW, doc 11)* — supervised (LogReg/NB/KNN/SVM/Trees/RF/boosting) + unsupervised (K-Means/DBSCAN/anomaly), DS pipeline, encoding/scaling + leakage, precision/recall/F1, bias-variance. Fills the classical-ML gap; interview staple → [11_classical_ml_algorithms.md](Agentic_AI/Level1_LLM_Foundations/Classical_ML_DL_Foundations/11_classical_ml_algorithms.md) + [practical](Agentic_AI/Level1_LLM_Foundations/Classical_ML_DL_Foundations/11_classical_ml_algorithms_practical.py)
  - [ ] 🟡 **Classical NLP pipeline** *(NEW, doc 12)* — cleaning, BoW→TF-IDF→N-grams→Word2Vec, cosine similarity, classical→modern-embedding bridge (why RAG embeddings + BM25 work) → [12_classical_nlp_pipeline.md](Agentic_AI/Level1_LLM_Foundations/Classical_ML_DL_Foundations/12_classical_nlp_pipeline.md) + [practical](Agentic_AI/Level1_LLM_Foundations/Classical_ML_DL_Foundations/12_classical_nlp_pipeline_practical.py)
