...
**GraphQL · Year 3-4 | Senior Backend + Agentic AI**
...
- `01_Year3-4_Mid/02_API_Design/19_asyncapi_event_driven_spec.md` — async API specs
- `01_Year3-4_Mid/05_Microservices/02_api_gateway_service_comm.md` — gateways
