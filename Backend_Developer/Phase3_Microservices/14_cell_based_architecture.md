...
- `Phase3_DevOps/15_multi_region_deployment.md` — multi-region
- `Phase3_DevOps/16_sre_practices_sli_slo.md` — SLOs per cell
- `Phase2_Database/10_postgresql_partitioning_sharding.md` — DB sharding
