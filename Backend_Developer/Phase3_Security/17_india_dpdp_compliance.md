...
- `Phase2_FastAPI/06_security_jwt_rbac.md` — auth foundation
- `Phase2_FastAPI/33_prompt_injection_security.md` — AI-era security
- `Phase3_DevOps/15_multi_region_deployment.md` — data localization infra
