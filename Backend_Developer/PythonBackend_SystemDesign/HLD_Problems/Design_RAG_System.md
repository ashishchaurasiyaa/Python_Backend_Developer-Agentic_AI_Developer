...
- `Phase2_FastAPI/34_rag_backend_architecture.md` — code-level RAG
- `Phase2_Database/06_pgvector_schema_design.md` — pgvector internals
- `Phase2_Database/18_pgvector_ai_workloads.md` — production tuning
