...
- [Phase2_FastAPI/15_websocket_scaling_patterns.md](../../Phase2_FastAPI/15_websocket_scaling_patterns.md) — WebSocket scaling
- [Phase2_Redis/02_redlock_distributed_locks.md](../../Phase2_Redis/02_redlock_distributed_locks.md) — distributed locks
- [Phase2_Kafka/](../../Phase2_Kafka/) — Kafka patterns
- [Phase3_Microservices/04_outbox_event_sourcing.md](../../Phase3_Microservices/04_outbox_event_sourcing.md) — event sourcing
- [Phase3_DevOps/16_sre_practices_sli_slo.md](../../Phase3_DevOps/16_sre_practices_sli_slo.md) — SLO design
