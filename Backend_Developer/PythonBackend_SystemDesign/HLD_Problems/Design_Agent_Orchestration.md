...
- `Phase2_FastAPI/32_function_calling_endpoints.md` — tool implementation
- `Phase2_FastAPI/35_mcp_server_implementation.md` — tool server
- `Phase3_Microservices/04_outbox_event_sourcing.md` — state durability
