...
**Phase 3 API Design | Senior Backend + Agentic AI**
...
- `Phase2_FastAPI/26_sse_deep.md` — SSE (works over HTTP/3)
- `Phase3_DevOps/02_nginx_deep.md` — Nginx config
- `Phase3_Security/06_cryptography_basics.md` — TLS 1.3
