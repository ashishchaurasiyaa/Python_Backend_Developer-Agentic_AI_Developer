...
RUN TESTS:
  python -m pytest Day35_Testing/01_unittest_pytest.py -v
  python -m pytest Day35_Testing/ -v --tb=short
...
print("\n✅ Day35 — unittest + pytest COMPLETE")
print("Topics: unittest, pytest, fixtures, parametrize, mocking, async testing, AI patterns")
print("\nRun with: python -m pytest Day35_Testing/01_unittest_pytest.py -v")
