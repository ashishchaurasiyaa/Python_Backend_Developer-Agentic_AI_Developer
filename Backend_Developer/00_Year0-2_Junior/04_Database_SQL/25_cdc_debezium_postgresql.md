...
- `01_Year3-4_Mid/05_Microservices/04_outbox_event_sourcing.md` — outbox pattern depth
- `01_Year3-4_Mid/05_Microservices/05_event_sourcing_cqrs.md` — event-driven architecture
