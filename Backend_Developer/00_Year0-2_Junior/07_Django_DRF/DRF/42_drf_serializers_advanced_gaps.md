...
- Repo cross-refs: `../practical/blog/serializers.py` (get_post_count, avatar context, dynamic fields variant), `../Django/38_django_model_inheritance_meta_constraints.md` (DB constraints vs validators race), `../Django/15_n_plus_one_detection.md`, `02_Year5+_Senior/.../SOLID_Principles.md` (BulkCreateMixin/AuditMixin)
