...
- [PythonBackend_SystemDesign/LLD_Theory/](../../PythonBackend_SystemDesign/LLD_Theory/) — Design patterns deep dive
- [PythonBackend_SystemDesign/LLD_Theory/07_Strategy_Pattern.md](../../PythonBackend_SystemDesign/LLD_Theory/07_Strategy_Pattern.md) — Strategy pattern used in our example
- [PythonBackend_SystemDesign/LLD_Theory/08_Observer_Pattern.md](../../PythonBackend_SystemDesign/LLD_Theory/08_Observer_Pattern.md) — Observer pattern
- [Phase3_Microservices/](../../Phase3_Microservices/) — Microservices architecture
- [PythonBackend_SystemDesign/HLD_Problems/Design_Amazon_Ecommerce.md](../../PythonBackend_SystemDesign/HLD_Problems/Design_Amazon_Ecommerce.md) — E-commerce HLD with all 3 layers
