...
- [Phase2_FastAPI/12_clean_architecture_ddd.md](../../Phase2_FastAPI/12_clean_architecture_ddd.md) — Clean architecture
- [PythonBackend_SystemDesign/LLD_Theory/07_Strategy_Pattern.md](../../PythonBackend_SystemDesign/LLD_Theory/07_Strategy_Pattern.md) — Strategy deep
- [PythonBackend_SystemDesign/LLD_Theory/08_Observer_Pattern.md](../../PythonBackend_SystemDesign/LLD_Theory/08_Observer_Pattern.md) — Observer deep
