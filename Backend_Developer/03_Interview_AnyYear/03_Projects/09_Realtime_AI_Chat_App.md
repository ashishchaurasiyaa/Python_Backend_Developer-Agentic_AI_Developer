...
- `00_Year0-2_Junior/06_FastAPI/37_voice_agent_backend.md` — voice mode
- `01_Year3-4_Mid/13_WebSocket_SSE/` — WebSocket fundamentals
- `02_Year5+_Senior/01_System_Design/HLD_Problems/Design_ChatGPT_Backend.md` — HLD reference
- `00_Year0-2_Junior/08_Redis/` — pub/sub patterns
