...
- `00_Year0-2_Junior/06_FastAPI/35_mcp_server_implementation.md` — implementation deep dive
- `00_Year0-2_Junior/06_FastAPI/32_function_calling_endpoints.md` — tool patterns
- `01_Year3-4_Mid/03_Security/17_india_dpdp_compliance.md` — audit requirements
- `02_Year5+_Senior/01_System_Design/HLD_Problems/Design_Agent_Orchestration.md` — agents using MCP
