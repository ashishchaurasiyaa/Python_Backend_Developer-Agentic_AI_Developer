...
- `00_Year0-2_Junior/06_FastAPI/34_rag_backend_architecture.md` — implementation deep dive
- `00_Year0-2_Junior/06_FastAPI/31_llm_integration_fastapi.md` — LLM patterns
- `00_Year0-2_Junior/06_FastAPI/33_prompt_injection_security.md` — security
- `00_Year0-2_Junior/04_Database_SQL/06_pgvector_schema_design.md` — pgvector
- `00_Year0-2_Junior/09_Caching/06_semantic_caching_llm.md` — cache layer
- `02_Year5+_Senior/01_System_Design/HLD_Problems/Design_RAG_System.md` — HLD reference
- `01_Year3-4_Mid/03_Security/17_india_dpdp_compliance.md` — compliance for India
